app.controller('admin.operation_list.ctrl', function ($scope, focus, $filter, $rootScope, $http) {

    var api_name = 'admin.operation_list';
    ...
    $scope.unWatch = $scope.$watch('langs.operation_user', function(){
        if ($rootScope.langs.operation_user) {
            $scope.unWatch();
