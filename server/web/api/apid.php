...
if (!$cmdstr) {
    ResultParser::error(DErrorCode::MISS_CMD);
}
$cmds = explode('.', $cmdstr);
if (isset($cmds[0])) {
...
if ($class && class_exists($class)) {
    ...
    ResultParser::error(DErrorCode::CLASS_NOT_FOUND, array('class' => $class));
}
if ($method && method_exists($obj, $method)) {
    ...
    ResultParser::error(DErrorCode::METHOD_NOT_FOUND, array('method' => $method));
}
